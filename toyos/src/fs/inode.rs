...
use easy_fs::{ATTRIBUTE_ARCHIVE, ATTRIBUTE_DIRECTORY, FAT32Manager, VFile};
...
impl File for OSInode {
    ...
    fn read(&self, mut buf: UserBuffer) -> usize {
        ...
        for slice in buf.buffer.iter_mut() {
